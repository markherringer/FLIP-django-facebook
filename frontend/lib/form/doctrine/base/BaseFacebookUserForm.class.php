...
/**
 * FacebookUser form base class.
 *
 * @method FacebookUser getObject() Returns the current form's model object
 *
 * @package    flip
 * @subpackage form
 ...
 */
abstract class BaseFacebookUserForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('facebook_user[%s]');
