...
/**
 * FlipFacebookUser filter form base class.
 *
 * @package    flip
 * @subpackage filter
 ...
 */
abstract class BaseFlipFacebookUserFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('flip_facebook_user_filters[%s]');
